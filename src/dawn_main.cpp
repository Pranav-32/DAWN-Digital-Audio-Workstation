...
public:
    ...
    void initialise(const juce::String &commandLineParameters) override {
        ...
        if (auto* peer = guiWindow_->getPeer()) {
            peer->setIcon(dawn::core::ResourceManager::getResource(dawn::resources::ImageID::dawn_logo));
        }
        guiWindow_->setIcon(dawn::core::ResourceManager::getResource(dawn::resources::ImageID::dawn_logo));
    }
